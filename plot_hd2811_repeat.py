...
if __name__ == "__main__":
    ...
    waves = np.array([7.7, 10.0, 11.3, 12.8, 15.0, 18.0, 21.0, 25.5])
    filters = [
        "F770W",
        "F1000W",
        "F1130W",
    ...
    for cfilter in filters:
        ...
        (mindx,) = np.where((obstab["name"] == sname) & (obstab["timemid"] < 59770. * u.day))
    ...
    ax.set_ylabel("flux (MJD=60106 d)/flux (MJD=59761 d) ")
    ...
    ax.set_title("HD 2811 repeat test")
